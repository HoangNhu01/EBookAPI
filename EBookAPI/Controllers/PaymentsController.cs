...
namespace eBook.WebApp.Controllers
{
    ...
    public class PaymentsController : Controller
    {
        ...
        public ActionResult PaymentRequest([FromBody]CheckOutRequest checkOutRequest)
        {
            ...
            pay.AddRequestData("vnp_OrderInfo", checkOutRequest.OrderId.ToString()); //Thông tin mô tả nội dung thanh toán
